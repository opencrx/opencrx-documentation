# openCRX 4.0 Development Guides #
...
1. [How to create custom projects](CustomProject.md)
1. [Introduction to the openCRX UML model](Modeling.md)
1. [How to use the REST servlet](Rest.md)
1. [How to write an openCRX Polymer client](PolymerClient.md)
1. [How to write a remote openCRX Java client](RemoteJavaClient.md)
1. [How to write a remote openCRX Android client](RemoteAndroidClient.md)
