...
```
java -jar opencrxServer-5.1.0-installer.jre-11.jar
```
...
Launch the shortcut _Start openCRX Server 5.1.0 (8080)_.
...
Launch the shortcut _Stop openCRX Server 5.1.0 (8080)_.
