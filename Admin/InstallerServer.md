...
```
java -jar opencrxServer-5.2.0-installer.jre-11.jar
```
...
Launch the shortcut _Start openCRX Server 5.2.0 (8080)_.
...
```
cd ./opencrxServer/apache-tomee-plus-8.0.6/bin
./opencrx.sh run
```
...
Launch the shortcut _Stop openCRX Server 5.2.0 (8080)_.
