...
This guide explains how to write a [Polymer](https://www.polymer-project.org/) client accessing _openCRX_ using the [RESTful API](40/Sdk/Rest.md).

## Prepare ##
This guide assumes that 

* the _openCRX 4.0 Server_ is successfully installed as described in [openCRX 4.0.0 Server Installation Guide](30/Admin/InstallerServer.md).
* the _openCRX/Sample_ custom project is installed as described in [How to create a custom project](40/Sdk/CustomProject.md).
...
The implementation using the _RESTful API_ is straight-forward. Use the _Swagger UI_ to explore the API. See [RESTful API](40/Sdk/Rest.md) for more information.
