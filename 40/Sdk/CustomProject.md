...
This guide assumes that the _openCRX SDK_ is installed (also see [here](40/Sdk/StepByStepEclipse.md)).
...
In a first step open a shell and cd to a directory where you have installed _openCRX SDK_ (see  [here](40/Sdk/StepByStepEclipse.md) for more information).
