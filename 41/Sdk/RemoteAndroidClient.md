...
* the _openCRX 4.1 Server_ is successfully installed as described in [openCRX 4.1.0 Server Installation Guide](41/Admin/InstallerServer/README.md).
* the _openCRX/Sample_ custom project is installed and deployed as described in [How to create a custom project](41/Sdk/CustomProject/README.md).
