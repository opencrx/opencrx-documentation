...
* _PostgreSQL_ as database (you can migrate to another supported database later on at any time. For more information see [here](41/Admin/DatabaseMigration.md)) 
...
* __Collation: C__ (allows ordering as required by _openCRX_. For more information see [here](41/Admin/DatabaseMigration.md))
...
Now you have a running (empty) _openCRX_ instance. Follow the instructions of the [upgrade guide](41/Admin/HowToUpgrade.md) in order to complete the installation of _openCRX_:
