...
* _PostgreSQL_ as database (you can migrate to another supported database later on at any time. For more information see [here](41/Admin/DatabaseMigration/README.md)) 

Select _Apache 2.2_ as frontend:

![img](41/Admin/files/InstallOnJelastic/pic010.png | width=320]]

Select _TomEE 1.7_ / _Java 8_ as application server:

![img](41/Admin/files/InstallOnJelastic/pic020.png | width=320]]

Select _PostgreSQL 9.4_ as database:

![img](41/Admin/files/InstallOnJelastic/pic030.png | width=320]]

After building the environment the layout should look as follows:

![img](41/Admin/files/InstallOnJelastic/pic040.png | width=960]]
...
![img](41/Admin/files/InstallOnJelastic/pic050.png | width=960]]
...
* __Collation: C__ (allows ordering as required by _openCRX_. For more information see [here](41/Admin/DatabaseMigration/README.md))
...
![img](41/Admin/files/InstallOnJelastic/pic060.png | width=960]]

The script should run without errors as shown below:

![img](41/Admin/files/InstallOnJelastic/pic070.png | width=960]]

Next we have to prepare _TomEE 1.7_. Click on the _Config_ button of the _TomEE_ node as shown below:

![img](41/Admin/files/InstallOnJelastic/pic080.png | width=960]]
...
![img](41/Admin/files/InstallOnJelastic/pic090.png | width=960]]
...
![img](41/Admin/files/InstallOnJelastic/pic100.png | width=960]]
...
![img](41/Admin/files/InstallOnJelastic/pic110.png | width=960]]
...
![img](41/Admin/files/InstallOnJelastic/pic120.png | width=960]]
...
![img](41/Admin/files/InstallOnJelastic/pic130.png | width=960]]
...
![img](41/Admin/files/InstallOnJelastic/pic140.png | width=960]]

Now restart the _TomEE_ node as shown below:

![img](41/Admin/files/InstallOnJelastic/pic150.png | width=960]]
...
![img](41/Admin/files/InstallOnJelastic/pic160.png | width=960]]

Now click on the _Open in browser_ icon. 

![img](41/Admin/files/InstallOnJelastic/pic170.png | width=960]]
...
![img](41/Admin/files/InstallOnJelastic/pic180.png | width=960]]

Now you have a running (empty) _openCRX_ instance. Follow the instructions of the [upgrade guide](41/Admin/HowToUpgrade/README.md) in order to complete the installation of _openCRX_:
