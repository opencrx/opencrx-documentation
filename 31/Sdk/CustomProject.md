...
This guide assumes that the _openCRX SDK_ is installed (also see [here](31/Sdk/StepByStepEclipse.md)).
...
In a first step open a shell and cd to a directory where you have installed _openCRX SDK_ (see  [here](31/Sdk/StepByStepEclipse.md) for more information).
