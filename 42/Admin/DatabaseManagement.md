...
__IMPORTANT:__ This guide assumes that _openCRX 4.2 Server_ is successfully setup as described in [openCRX 4.2.0 Server Installation Guide](Admin/InstallerServer/README.md).
