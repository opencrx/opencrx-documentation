...
* the _openCRX 4.2 Server_ is successfully installed as described in [openCRX 4.2.0 Server Installation Guide](Admin/InstallerServer/README.md).
* the _openCRX/Sample_ custom project is installed and deployed as described in [How to create a custom project](Sdk/CustomProject/README.md).
