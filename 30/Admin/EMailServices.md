...
See [Configuring Automated Workflows](30/Admin/AutomatedWorkflows/README.md) for details on activating / configuring the MailImporterServlet the MailImporterServlet. With the following steps you can configure the MailImporterServlet:
