...
__IMPORTANT:__ This guide assumes that _openCRX 3.0 Server_ is successfully setup as described in [openCRX 3.0.0 Server Installation Guide](30/Admin/InstallerServer/README.md).
...
* _PostgreSQL_ as database (you can migrate to another supported database later on at any time. For more information see [here](30/Admin/DatabaseMigration/README.md)) 
...
* __Collation: C__ (allows ordering as required by _openCRX_. For more information see [here](30/Admin/DatabaseMigration/README.md))
...
Now you have a running (empty) _openCRX_ instance. Follow the instructions of the [upgrade guide](30/Admin/HowToUpgrade/README.md) in order to complete the installation of _openCRX_:
